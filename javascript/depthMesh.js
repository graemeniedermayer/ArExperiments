	...
	if (pose) {
		for (const view of pose.views) {
            ...
            if (depthData && captureNext) {
				...
				mesh = new THREE.Mesh( geometry, new THREE.MeshStandardMaterial( { color:'rgba(100,200,100,1)'} ) );
...
let removeButton = document.getElementById('deleteMesh').addEventListener('click', ()=>{
