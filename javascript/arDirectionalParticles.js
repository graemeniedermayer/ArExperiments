...
let fire1Emitter = new DirectionalEmitter()
let fire2Emitter = new DirectionalEmitter()
let fire3Emitter = new DirectionalEmitter()
...
fire1Emitter.AddParticles(1, group1.position);
fire2Emitter.AddParticles(1, group2.position);
fire3Emitter.AddParticles(1, group3.position);
...
guiWrap = (emitter, particleSystem, guiSystem, textureName)=>{
  ...
  guiSystem.add(params, "blend", 0.0, 1.0).onChange(
    emitterChange);
  guiSystem.add(params, "speed", 0.0, 30.0).onChange(
    emitterChange);
